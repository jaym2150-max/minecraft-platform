export default function ApiAuthPage() {
  return (
    <article>
      ...
      <p>
        The API uses JWT-based authentication. All authenticated endpoints expect a Bearer token
  ...
  "password": "SecureP@ss123"
     ...
     http://localhost:4000/api/v1/auth/me</code></pre>
  ...
  "email": "me@example.com"
      ...
      <p>
        <code>POST /auth/reset-password</code> - Completes the password reset using a token
        from the email.
      </p>
      <pre><code>{`{
  ...
  "password": "NewSecureP@ss456"
      ...
      <p>
        Tokens expire after <code>JWT_EXPIRATION</code> (default: 15 minutes). When a token
        expires, you'll receive a <code>401 Unauthorized</code> response. The web client handles
        this automatically by redirecting to the login page.
      </p>
