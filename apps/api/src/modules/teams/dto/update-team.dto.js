...
exports.UpdateTeamMemberDto = exports.AddTeamMemberDto = exports.UpdateTeamDto = void 0;
...
var AddTeamMemberDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _role_decorators = [(0, class_validator_1.IsEnum)(client_1.TeamRole)];
...
var UpdateTeamMemberDto = function () {
    var _a;
    var _role_decorators;
    var _role_initializers = [];
    var _role_extraInitializers = [];
    return _a = /** @class */ (function () {
            function UpdateTeamMemberDto() {
                this.role = __runInitializers(this, _role_initializers, void 0);
                __runInitializers(this, _role_extraInitializers);
            }
            return UpdateTeamMemberDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _role_decorators = [(0, class_validator_1.IsEnum)(client_1.TeamRole)];
