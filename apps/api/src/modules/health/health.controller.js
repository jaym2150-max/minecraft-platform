...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(config) {
            this.config = (__runInitializers(this, _instanceExtraInitializers), config);
            this.logger = new common_1.Logger(HealthController.name);
        }
        HealthController_1.prototype.check = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.checkClamav()];
                        case 1:
                            clamav = _a.sent();
                            return [2 /*return*/, {
                                    status: 'ok',
        ...
        HealthController_1.prototype.checkClamav = function () {
            return __awaiter(this, void 0, void 0, function () {
                var host, port;
                return __generator(this, function (_a) {
    ...
    (function () {
        ...
        _check_decorators = [(0, common_1.Get)(), (0, public_decorator_1.Public)()];
