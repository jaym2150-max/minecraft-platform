...
var GithubStrategy = function () {
    ...
    var _classThis;
    var _classSuper = (0, passport_1.PassportStrategy)(passport_github2_1.Strategy, 'github');
    var GithubStrategy = _classThis = /** @class */ (function (_super) {
        __extends(GithubStrategy_1, _super);
        function GithubStrategy_1(configService, prisma) {
            var _this = this;
            var clientID = configService.get('app.githubClientId');
            var clientSecret = configService.get('app.githubClientSecret');
            ...
            _this = _super.call(this, {
                ...
                callbackURL: "".concat(configService.get('app.apiUrl') || 'http://localhost:4000', "/api/v1/auth/github/callback"),
                scope: ['user:email'],
            }) || this;
            _this.configService = configService;
            _this.prisma = prisma;
            _this.logger = new common_1.Logger(GithubStrategy.name);
            _this.configured = false;
            _this.configured = hasConfig;
            return _this;
        }
        GithubStrategy_1.prototype.validate = function (accessToken, refreshToken, profile) {
            return __awaiter(this, void 0, void 0, function () {
                var id, username, email, avatarUrl, displayName, user, _a, _b;
                var _c, _d;
                var _e, _f, _g, _h;
                return __generator(this, function (_j) {
                    switch (_j.label) {
                        case 0:
                            if (!this.configured) {
                                throw new common_1.UnauthorizedException('GitHub OAuth is not configured');
                            }
                            id = String(profile.id);
                            username = profile.username;
                            email = (_f = (_e = profile.emails) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.value;
                            avatarUrl = (_h = (_g = profile.photos) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.value;
                        ...
                        case 6:
                            ...
                            _c = {};
                            _d = {};
                            return [4 /*yield*/, this.uniqueUsername(username || "gh-".concat(id))];
                        case 7: return [4 /*yield*/, _b.apply(_a, [(_c.data = (_d.username = _j.sent(),
                                    _d.email = email !== null && email !== void 0 ? email : "".concat(id, "@github.oauth"),
        ...
        GithubStrategy_1.prototype.uniqueUsername = function (base) {
            return __awaiter(this, void 0, void 0, function () {
                var username, suffix;
