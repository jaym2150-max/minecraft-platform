...
var discord_strategy_1 = require("./discord.strategy");
var oauth_consent_code_service_1 = require("./oauth-consent-code.service");
...
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy, github_strategy_1.GithubStrategy, discord_strategy_1.DiscordStrategy, oauth_consent_code_service_1.OAuthConsentCodeService],
            exports: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy, passport_1.PassportModule, oauth_consent_code_service_1.OAuthConsentCodeService],
        })];
