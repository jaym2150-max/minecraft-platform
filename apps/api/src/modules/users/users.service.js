...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.formatUser = function (user) {
            var _a, _b, _c;
            ...
            var passwordHash = user.passwordHash, rest = __rest(user, ["passwordHash"]);
            void passwordHash;
            return __assign(__assign({}, rest), { displayName: (_a = user.displayName) !== null && _a !== void 0 ? _a : undefined, avatarUrl: (_b = user.avatarUrl) !== null && _b !== void 0 ? _b : undefined, bio: (_c = user.bio) !== null && _c !== void 0 ? _c : undefined, role: user.role, createdAt: user.createdAt.toISOString(), updatedAt: user.updatedAt.toISOString() });
        };
        UsersService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUsername, existingEmail, user;
                var _a;
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.prisma.user.create({
                                    data: {
                                        ...
                                        role: (_a = data.role) !== null && _a !== void 0 ? _a : types_1.UserRole.USER,
                                    },
                                })];
                        case 3:
                            user = _b.sent();
                            return [2 /*return*/, this.formatUser(user)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            if (!user)
                                return [2 /*return*/, null];
                            result = __assign(__assign({}, user), { displayName: (_a = user.displayName) !== null && _a !== void 0 ? _a : undefined, avatarUrl: (_b = user.avatarUrl) !== null && _b !== void 0 ? _b : undefined, bio: (_c = user.bio) !== null && _c !== void 0 ? _c : undefined, followerCount: user._count.followers, followingCount: user._count.following });
         ...
         */
        UsersService_1.prototype.toPublicProfile = function (user) {
            var _a, _b;
            return {
                id: user.id,
                ...
                bio: user.bio,
                role: user.role,
                followerCount: (_a = user.followerCount) !== null && _a !== void 0 ? _a : undefined,
                followingCount: (_b = user.followingCount) !== null && _b !== void 0 ? _b : undefined,
            };
        };
        ...
        UsersService_1.prototype.findByEmailInternal = function (email) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
         ...
         */
        UsersService_1.prototype.getPasswordHash = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            return [2 /*return*/, (_a = user === null || user === void 0 ? void 0 : user.passwordHash) !== null && _a !== void 0 ? _a : null];
                    }
                });
            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            updatedUser = _a.sent();
                            return [2 /*return*/, this.formatUser(updatedUser)];
                    }
                });
            });
        };
        ...
        UsersService_1.prototype.comparePassword = function (password, passwordHash) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, bcrypt.compare(password, passwordHash)];
                });
            });
        };
