...
var user_follows_service_1 = require("./user-follows.service");
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [prisma_module_1.PrismaModule, projects_module_1.ProjectsModule],
            controllers: [users_controller_1.UsersController],
            providers: [users_service_1.UsersService, user_follows_service_1.UserFollowsService],
            exports: [users_service_1.UsersService, user_follows_service_1.UserFollowsService],
        })];
