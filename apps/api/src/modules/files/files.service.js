...
var FilesService = function () {
    ...
    var FilesService = _classThis = /** @class */ (function () {
        ...
        FilesService_1.prototype.getDownloadUrl = function (objectKey) {
            return __awaiter(this, void 0, void 0, function () {
                var command;
                return __generator(this, function (_a) {
                    if (this.cdnDomain) {
                        return [2 /*return*/, "".concat(this.cdnDomain, "/").concat(this.bucket, "/").concat(objectKey)];
                    }
                    command = new client_s3_1.GetObjectCommand({
                        Bucket: this.bucket,
                        Key: objectKey,
                    });
                    return [2 /*return*/, (0, s3_request_presigner_1.getSignedUrl)(this.s3, command, { expiresIn: 3600 })];
                });
            });
        };
        FilesService_1.prototype.getObjectKeyFromUrl = function (fileUrl) {
            var endpoint = this.config.get('storage.endpoint');
            var prefix = "".concat(endpoint, "/").concat(this.bucket, "/");
