...
exports.UpdateProjectFeatureDto = void 0;
var class_validator_1 = require("class-validator");
var UpdateProjectFeatureDto = function () {
    var _a;
    var _featured_decorators;
    var _featured_initializers = [];
    var _featured_extraInitializers = [];
    return _a = /** @class */ (function () {
            function UpdateProjectFeatureDto() {
                this.featured = __runInitializers(this, _featured_initializers, void 0);
                __runInitializers(this, _featured_extraInitializers);
            }
            return UpdateProjectFeatureDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _featured_decorators = [(0, class_validator_1.IsBoolean)()];
...
exports.UpdateProjectFeatureDto = UpdateProjectFeatureDto;
