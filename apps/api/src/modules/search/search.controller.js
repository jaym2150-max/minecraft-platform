...
var SearchController = function () {
    var _classDecorators = [(0, common_1.Controller)('search')];
    ...
    var SearchController = _classThis = /** @class */ (function () {
        ...
        SearchController_1.prototype.search = function () {
            return __awaiter(this, arguments, void 0, function (q, page, limit, category, loader, sort) {
                var _a, data, meta;
                if (q === void 0) { q = ''; }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.searchService.search(q, {
                                page: Number(page),
                                limit: Number(limit),
                                category: category,
                                loader: loader,
        ...
        SearchController_1.prototype.reindex = function () {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.searchService.reindexAll()];
                        case 1:
                            data = _a.sent();
                            return [2 /*return*/, {
                                    statusCode: common_1.HttpStatus.OK,
    ...
    (function () {
        ...
        _search_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)()];
        _reindex_decorators = [(0, common_1.Post)('reindex'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('ADMIN', 'OWNER'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
