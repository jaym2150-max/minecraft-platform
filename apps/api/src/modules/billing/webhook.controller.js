...
var WebhookController = function () {
    var _classDecorators = [(0, common_1.Controller)('billing/webhook')];
    ...
    var WebhookController = _classThis = /** @class */ (function () {
        function WebhookController_1(billing) {
            this.billing = (__runInitializers(this, _instanceExtraInitializers), billing);
        }
        WebhookController_1.prototype.handleWebhook = function (req, signature) {
            return __awaiter(this, void 0, void 0, function () {
                var raw;
                return __generator(this, function (_a) {
                    raw = req.rawBody || Buffer.from(JSON.stringify(req.body));
                    return [2 /*return*/, this.billing.handleStripeWebhook(raw, signature)];
                });
            });
        };
    ...
    (function () {
        ...
        _handleWebhook_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)()];
