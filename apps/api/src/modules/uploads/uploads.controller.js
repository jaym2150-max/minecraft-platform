...
var UploadsController = function () {
    var _classDecorators = [(0, common_1.Controller)('uploads'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var UploadsController = _classThis = /** @class */ (function () {
        ...
        UploadsController_1.prototype.uploadFile = function (projectId, file, userId) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.uploadsService.initiateUpload(userId, projectId, file)];
                        case 1:
                            data = _a.sent();
                            return [2 /*return*/, {
        ...
        UploadsController_1.prototype.getStatus = function (uploadId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.uploadsService.getUploadStatus(uploadId, userId)];
                        case 1:
                            data = _a.sent();
                            return [2 /*return*/, {
        ...
        UploadsController_1.prototype.cancel = function (uploadId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.uploadsService.cancelUpload(uploadId, userId)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, {
                                    statusCode: common_1.HttpStatus.OK,
    ...
    (function () {
        ...
        _uploadFile_decorators = [(0, common_1.Post)('project/:projectId'), (0, common_1.HttpCode)(common_1.HttpStatus.ACCEPTED), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
                storage: (0, multer_1.memoryStorage)(),
                limits: { fileSize: 50 * 1024 * 1024 },
            }))];
        _getStatus_decorators = [(0, common_1.Get)(':uploadId/status')];
        _cancel_decorators = [(0, common_1.Delete)(':uploadId'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
