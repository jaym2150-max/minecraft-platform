...
var api_keys_controller_1 = require("./api-keys.controller");
var api_keys_service_1 = require("./api-keys.service");
var prisma_module_1 = require("../../common/prisma/prisma.module");
var ApiKeysModule = function () {
    ...
    var _classThis;
    var ApiKeysModule = _classThis = /** @class */ (function () {
        function ApiKeysModule_1() {
        }
        return ApiKeysModule_1;
    }());
    __setFunctionName(_classThis, "ApiKeysModule");
    (function () {
