...
var CategoriesService = function () {
    ...
    var CategoriesService = _classThis = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            categories = _a.sent();
                            return [2 /*return*/, categories.map(function (c) { return _this.formatCategory(c); })];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            category = _a.sent();
                            if (!category) {
                                throw new common_1.NotFoundException("Category with slug \"".concat(slug, "\" not found"));
                            }
                            return [2 /*return*/, this.formatCategory(category)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.prisma.project.count({ where: { categoryId: id } })];
                        case 2:
                            inUse = _a.sent();
                            if (inUse > 0) {
                                throw new common_1.ConflictException("Cannot delete category: ".concat(inUse, " project(s) still use this category"));
                            }
        ...
        CategoriesService_1.prototype.formatCategory = function (category) {
            var _a, _b, _c, _d;
            return {
                id: category.id,
                name: category.name,
                ...
                icon: (_b = category.icon) !== null && _b !== void 0 ? _b : undefined,
                color: (_c = category.color) !== null && _c !== void 0 ? _c : undefined,
                order: category.order,
                projectCount: (_d = category._count) === null || _d === void 0 ? void 0 : _d.projects,
