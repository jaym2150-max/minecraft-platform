...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        ...
        function JwtAuthGuard_1(reflector, apiKeysService) {
            var _this = _super.call(this) || this;
            _this.reflector = reflector;
            _this.apiKeysService = apiKeysService;
            return _this;
        }
        ...
        JwtAuthGuard_1.prototype.extractApiKey = function (request) {
        ...
        JwtAuthGuard_1.prototype.validateApiKey = function (svc, key, request) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, svc.validate(key)];
                        case 1:
                            result = _a.sent();
                            if (!result) {
