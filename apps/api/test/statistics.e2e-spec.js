...
describe('Statistics E2E', function () {
    var app;
    ...
    describe('GET /statistics', function () {
        it.skip('should return instance-wide statistics (requires controller)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe('GET /projects/random', function () {
        it.skip('should return random published projects (requires controller)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request(app.getHttpServer())
